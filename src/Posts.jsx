...
export function Posts() {
  ...
  return (
    <>
      ...
      <div className='pages'>
        <button disabled={currentPage <= 1} onClick={() => setCurrentPage((prevState) => prevState - 1)}>
          Previous page
        </button>
        <span>Page {currentPage}</span>
        <button disabled={currentPage >= maxPostPage} onClick={() => setCurrentPage((prevState) => prevState + 1)}>
          Next page
        </button>
      </div>
      <hr />
